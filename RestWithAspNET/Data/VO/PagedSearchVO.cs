...
namespace RestWithAspNET.Data.VO
{
    public class PagedSearchVO<T> where T : ISupportsHyperMedia
    {
        ...
        public PagedSearchVO(int currentPage, int pageSize, int totalResults, string sortFields, string sortDirections, Dictionary<string, object> filters, List<T> list)
        {
